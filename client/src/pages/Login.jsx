      ...
      <div className='w-full max-w-[440px] px-4 relative z-10 flex flex-col items-center'>
        <div className='text-center -mt-9 mb-6'>
          <h1 className='text-[32px] md:text-[40px] font-bricolage font-bold tracking-tight mb-2 leading-[1.1]'>
            <span className='text-zinc-100'>The omniscient</span>
            <br />
          ...
          <form onSubmit={handleSubmit(onSubmit)} className='space-y-5'>
            <div className='space-y-1.5'>
              ...
              <div className='relative'>
                ...
                <input
                  ...
                  className={`w-full bg-[#1a1d21] border ${errors.email ? "border-red-500/50" : "border-white/5"} rounded-xl pl-10 pr-4 py-3 text-[14px] font-dmsans text-white placeholder:text-zinc-600 focus:outline-none focus:border-teal-500/50 focus:bg-[#1f2328] transition-all`}
                />
              </div>
              {errors.email && (
            ...
            <div className='space-y-1.5'>
              ...
              <div className='relative'>
                ...
                <input
                  ...
                  className={`w-full bg-[#1a1d21] border ${errors.password ? "border-red-500/50" : "border-white/5"} rounded-xl pl-10 pr-10 py-3 text-[14px] font-dmsans text-white placeholder:text-zinc-600 focus:outline-none focus:border-teal-500/50 focus:bg-[#1f2328] transition-all`}
                />
                <button
                  type='button'
            ...
            <div className='flex justify-end -mt-3'>
              <Link
                ...
                className='text-[12px] text-zinc-400 font-dmsans hover:text-teal-300 transition-colors tracking-wide'
              >
                Forgot password?
              </Link>
            </div>
            ...
            <button
              type='submit'
              disabled={isLoading}
              className='w-full flex items-center justify-center gap-2 bg-linear-to-r from-[#1eb2a6] to-[#0d9488] hover:from-[#20c0b4] hover:to-[#0faba0] text-white rounded-[14px] py-2.5 text-[17px] font-dmsans transition-all duration-200 shadow-[0_4px_20px_rgba(20,184,166,0.3)] disabled:opacity-50 cursor-pointer active:scale-[0.98]'
            >
              {isLoading ? (
                <>
