        ...
        <div className='flex items-center gap-2'>
          <div className='relative'>
            ...
            <select
              ...
              className='pl-9 pr-4 py-2 bg-white border border-gray-200/60 rounded-xl text-sm font-medium text-gray-700 focus:outline-none focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500 transition-all cursor-pointer shadow-sm appearance-none min-w-45'
            >
